...
const PainelAtrasosPage = lazy(pages["/atrasos"]);
            ...
            <TooltipProvider>
              ...
              <BrowserRouter>
                ...
                <Routes>
                  ...
                  <Route path="/estoque" element={<Navigate to="/medicamentos" replace />} />
                  ...
                  <Route path="/atrasos" element={<P><S><PainelAtrasosPage /></S></P>} />
