          ...
          <header className="h-[60px] flex items-center justify-between border-b border-border/40 bg-card/50 backdrop-blur-2xl px-3 sm:px-5 sticky top-0 z-10">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <Button
                ...
                size="icon"
                onClick={toggleTheme}
                className="text-muted-foreground hover:text-foreground h-8 w-8 rounded-xl hover:bg-accent/20 transition-all"
              >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center gap-2.5 rounded-xl px-2 py-1.5 hover:bg-accent/15 transition-all group outline-none">
                    <div className="relative">
                      <Avatar className="h-8 w-8 ring-2 ring-primary/10 group-hover:ring-primary/30 transition-all">
                        <AvatarFallback className="bg-gradient-to-br from-primary/20 via-primary/10 to-accent/10 text-primary text-[11px] font-bold">
                          {displayInitials}
                        </AvatarFallback>
                      </Avatar>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        <Avatar className="h-10 w-10 ring-2 ring-primary/15">
                          <AvatarFallback className="bg-gradient-to-br from-primary/20 via-primary/10 to-accent/10 text-primary text-sm font-bold">
                            {displayInitials}
                          </AvatarFallback>
                        </Avatar>
                      ...
                      <div>
                        <p className="text-sm font-bold" style={{ fontFamily: "var(--font-display)" }}>{displayName}</p>
                        <Badge
                          variant="outline"
                          className={cn(
